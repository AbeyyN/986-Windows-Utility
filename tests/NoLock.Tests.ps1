...
if ($activeRows.Count -ne 26) { throw "Expected 26 active preference tweaks; found $($activeRows.Count)." }
...
Write-Host 'PASS: 26 active tweaks are non-policy, user-editable, one-shot preferences; 4 old policy tweaks are undo-only.' -ForegroundColor Green