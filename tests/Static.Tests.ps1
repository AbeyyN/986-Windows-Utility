...
if ($text -notmatch '\$Version = ''0\.7\.0-rc\.1''') { throw 'Expected application version 0.7.0-rc.1.' }
...
Write-Host "PASS: v0.7 RC app/modules parse clean, 30 active + 4 legacy tweaks, Storage and Resolution UI present." -ForegroundColor Green