...
Write-Host "PASS: v0.7 app/modules parse clean, release version matches CHANGELOG, 30 active + 4 legacy tweaks, Storage and Resolution UI present." -ForegroundColor Green
