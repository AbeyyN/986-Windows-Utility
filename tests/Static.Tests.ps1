...
if ($text -notmatch '\$Version = ''0\.6\.0''') { throw 'Expected application version 0.6.0.' }
...
Write-Host "PASS: v0.6 app/modules/bootstrap parse clean, 30 active + 4 legacy tweaks, Profiles present." -ForegroundColor Green