...
if ($text -notmatch '\$Version = ''0\.4\.0''') { throw 'Expected application version 0.4.0.' }
...
Write-Host "PASS: v0.4 app/modules/bootstrap parse clean, $($ids.Count) unique tweaks, Profiles present." -ForegroundColor Green
