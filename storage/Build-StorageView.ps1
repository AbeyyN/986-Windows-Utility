...
$cmd = '"' + $vcvars + '" && cl /nologo /std:c++17 /EHsc /DUNICODE /D_UNICODE /LD "' + $shellSource + '" /link /DEF:"' + $shellDef + '" ole32.lib shell32.lib user32.lib gdi32.lib gdiplus.lib uuid.lib /OUT:"' + $shellOut + '"'
